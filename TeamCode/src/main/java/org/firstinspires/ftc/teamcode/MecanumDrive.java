...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.8227525572908844; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 14.790474436191381;

        // feedforward parameters (in tick units)
        public double kS = 0.9748570710181408;
        public double kV = 0.1823533030308136;
